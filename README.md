...
这套架构保障执行边界和创作证据，不承诺任何模型每次都生成完美文学结果。工程控制面、可编辑产物交付和费用停止策略已经完成真实验证；独立作者对照评测与社区质量门仍待完成，因此创作可靠性入口保持实验性。详见 [Agent + Harness 架构更新说明](./docs/AI-HARNESS-REBUILD-RELEASE-20260817.md)。
