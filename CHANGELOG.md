...
- **新增全局设定协调机制**：所有 AI 生成面板新增 🎯仅本面板 / 🌐全局协调 切换开关，默认开启全局协调模式，确保 AI 生成任一设定时能看到全部 13 个设定源（世界观/力量体系/角色/词条/规则/历史/地点/伏笔/故事线/年表/角色关系），不再出现"设定之间互不相通、牛头不对马嘴"的问题。
- **新增设定对齐工具**：侧边栏「设置区」→「设定对齐」，一键用 AI 扫描全部已有设定，检测时间线/实力/地理/规则/关系/数量/存在性七类矛盾，逐条展示左右原文对照、矛盾原因和修复建议。
- **新增冷战式氛围题材包**：适用于架空异世界的冷战式氛围创作——阵营对峙、技术限制（前数字时代）、终极武器阴影、情报暗战。非历史复刻，可与魔法/超凡元素共存。含章节正文、卷纲、角色设计、故事核心、世界观维度五套提示词，并附带冷战科技参考手册。
