...
Esta arquitectura protege los límites de ejecución y ofrece pruebas auditables; no promete una salida literaria perfecta con todos los modelos. Se han verificado la recuperación técnica, la entrega editable y la detención de costes; aún faltan comparaciones independientes entre autores y una validación comunitaria de calidad. Consulte la [nota de actualización de la arquitectura de ejecución](../AI-HARNESS-REBUILD-RELEASE-20260817.md).
