...
この構造が保証するのは実行境界と検証可能な証拠であり、どのモデルからも常に完全な文学作品が得られるという約束ではありません。技術的な再開、編集可能な成果物の保持、費用停止の動作は検証済みですが、独立した作者比較と共同体による品質判定は今後の課題です。詳しくは[実行基盤の更新説明](../AI-HARNESS-REBUILD-RELEASE-20260817.md)を参照してください。
