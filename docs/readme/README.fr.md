...
Cette architecture encadre l’exécution et fournit des preuves vérifiables ; elle ne garantit pas un résultat littéraire parfait avec chaque modèle. La reprise technique, la livraison modifiable et l’arrêt des dépenses ont été vérifiés, tandis que les comparaisons indépendantes entre auteurs et la validation communautaire restent à réaliser. Voir la [note de version de l’architecture d’exécution](../AI-HARNESS-REBUILD-RELEASE-20260817.md).
