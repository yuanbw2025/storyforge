...
>
> **最后更新**: 2026-07-13（QUICKWIN-4 已写正文参与卷纲/章纲生成已实现待审；此前追加透明生成管线 PIPELINE-1~3、认知账本 CONSISTENCY-2/3、一致性覆盖地图 CONSISTENCY-0；追加大纲章节跨卷拖动、物品栏提取范围优化、状态卡/物品栏职责澄清方案、社区反馈待开发批次等；施工权威见 MASTER-BLUEPRINT）
...
## 🟠 QUICKWIN-4 · 已写正文参与卷纲 / 章纲生成：补大纲时尊重既有正文事实（已实现待审 `codex/quickwin-written-progress-outline-20260713`）
...
## 🟢 QUICKWIN-6 · 大纲章节支持跨卷拖动：从第一卷移动到第二卷 · 已实现待审 `codex/outline-cross-parent-drag-20260711`
...
## 🟡 EDITOR-1 · 全书查找替换(通用刚需 · 长篇痛点 · 作者点名要做) · 已实现待审 `codex/editor-find-replace-20260711`
