...
> 版本：2.9.1 · 更新：2026-09-25 · 权威层级：L1
...
- `/openworld/:pageId?`：文字开放世界真实 S2/S3 Creator、质量/媒资、发布和确定性玩家入口；根路径、制作、定向与游玩深链均进入同一专属产品。页面同时承接内置展示作品与仍受成熟度闸门限制的创作能力。
...
| TypeScript 生产源码 | 1359 个文件 / 509659 行 | `tsconfig.json` |
...
| CONTEXT_SOURCES | 132 个上下文源 | `context-sources.ts` |
