...
| TypeScript 生产源码 | 540 个文件 / 117696 行 | `tsconfig.json` |
| IndexedDB schema | v49 / 62 张 required tables | `schema.ts` / `REQUIRED_TABLES` |
| PROJECT_TABLES | 62 张表 | `project-tables.ts` |
