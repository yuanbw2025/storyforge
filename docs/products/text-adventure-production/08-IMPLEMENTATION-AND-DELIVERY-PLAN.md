...
状态：真实生产进行中，尚未形成可试玩 Build。隔离世界 `潮钟群岛旗舰来源世界 v4`、商业候选 Brief、冻结 SourcePlan 和来源私域补充决定已经建立；已完成 38/47 项 durable task，叙事、任务、对白、连续性审查、美术需求与视觉圣经均已有真实候选。当前旧 Brief 仅计划 2 张图，低于商业关键插图 12 张底线，系统已在 `media.anchor-author-gate` 禁止确认和 Provider 消耗；必须由作者取消旧 Build、以修正 Brief 重新授权，不能绕过闸门或用既有工件冒充可发布成品。
