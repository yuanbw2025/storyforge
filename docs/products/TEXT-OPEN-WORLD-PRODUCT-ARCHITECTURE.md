...
这完成了G7-15的工程退场部分。退场后的17项开放世界隔离Chromium路径已经覆盖战斗、完整旅程、制作经济、Creator生命周期、来源、玩家壳、运行时AI、存档、场景、教程和世界记录；TTRPG规则域与只服务旧Release的兼容reducer已从共享运行核心拆出，`runtime-core`在不放宽预算且无循环chunk的前提下通过600/180KiB门。最终全仓CI又通过699个测试文件、3554项测试、84.49%语句覆盖率、生产构建与bundle闸门，G7-15已无工程和自动化待项。这里仍不提前宣告最终产品交付：G7-14真实更新证据仍是最终DONE条件；因此完成能力索引与面向用户的正式完成说明只在该门解除后更新。
