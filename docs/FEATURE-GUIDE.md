...
StoryForge 是一个本地优先的 AI 小说创作工作台。它把“项目资料、世界观、角色、大纲、正文、伏笔、状态、事实、导入导出、提示词”放在同一个创作空间里，并通过统一 Agent + Harness 让生成的输入、候选、问题、用量和确认过程可见、可恢复、可停止。
...
当前创作可靠性入口仍属于实验性能力。工程恢复与费用边界已经完成真实验证，但独立作者 A/B 尚未完成；它不能被理解为“任何模型都能稳定生成完美长篇”。
