...
| `short-novel-release-lifecycle` | `creationReleases` | `SHORT_NOVEL_RELEASE_V1 + PROJECT_TABLES + completion gates + immutable hash` | `src/lib/short-novel/service.ts` | 2027-09-06 |
