...
| 跑团/聊天/AI 小镇/文字游戏 | WorldReference、产品 requirement adapter、Brief/SourcePlan/SourceManifest、production/build/release/session | `products/UPPER-PRODUCTS.md`、目标产品契约（文字冒险读 `products/TEXT-ADVENTURE.md`）、目标产品代码、中立世界资源协议和 owner | 其它上层产品内部细节 |
