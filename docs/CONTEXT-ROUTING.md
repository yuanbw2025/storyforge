...
| 跑团/聊天/AI 小镇/文字游戏 | WorldReference、产品 requirement adapter、Brief/SourcePlan/SourceManifest、production/build/ProductRelease/session | `products/UPPER-PRODUCTS.md`、目标产品代码、中立世界资源协议和 owner；文字开放世界施工先读 `products/TEXT-OPEN-WORLD-PRODUCT-ARCHITECTURE.md`，按工作包开工或更新进度时读 `roadmap/TEXT-OPEN-WORLD-IMPLEMENTATION-PLAN.md`，叙事生产再读 `products/TEXT-OPEN-WORLD-NARRATIVE-BASE-ARCHITECTURE.md`，制作验收世界时读 `products/TEXT-OPEN-WORLD-SALT-RIDGE-BRIEF.md`，历史原因读取 `products/TEXT-OPEN-WORLD-VISION-AND-EVOLUTION.md` | 其它上层产品内部细节 |
| 新体系或完整产品 | 总纲阶段、稳定 ID、依赖和当前能力状态 | 总纲、对应产品契约、能力基线、路线图与质量标准；文字开放世界 G1/G2 开工时再读 `roadmap/TEXT-OPEN-WORLD-WORK-PACKAGE-CARDS.md` 对应行 | 旧任务名驱动的历史方案 |
