...
| 离线评测 | `NS-0`、NS/AGENT/PIPELINE 回归、H4 40+20 runner、H82～H84 真实模型证据 | 有 development/held-out fixture、预算、事实/约束/泄漏/证据指标；H83 闭合集纠错闭合 protocol completion，H84 又冻结 19 subtype 操作定义/边界、clean/数量门、全约束 repair、同输入停止和非重试 4xx 单次终止 | Agnes v7 虽完成 40/40，但 precision/recall 仍仅 61.8%/65.6%；Doubao v7 被真实 `403 AccountOverdueError` 阻断。held-out 保持锁定，仍缺可靠 verifier、诚实多调用定向 adjudication、真实 generator 主链 A/B、人工修改量/完成率/p95 与独立人工复核 | B（工程、协议恢复与真实负面证据），D（发布质量证据） |
