...
| 离线评测 | `NS-0`、NS/AGENT/PIPELINE 回归、H4 40+20 runner、H82/H83 真实模型证据 | 有 development/held-out fixture、预算、事实/约束/泄漏/证据指标；HARNESS-83 用无标签泄漏闭集纠错使 Agnes 与 Doubao 都完成 40/40，artifact/checkpoint 可验签 | 两模型 precision/recall 仅 45.5%–51.7% / 46.9%，均未通过 development；held-out 保持锁定，仍缺可靠 verifier、真实 generator 主链 A/B、人工修改量/完成率/p95 与独立人工复核 | B（工程、协议恢复与真实负面证据），D（发布质量证据） |
