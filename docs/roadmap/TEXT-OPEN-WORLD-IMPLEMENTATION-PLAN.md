...
|---|---|
| 首版工作包 | 121 |
| 已完成 | 103（G0、G1、G2、G3、G4、G5及G6-01～G6-07完成） |
| 产品总进度 | 103 / 121（85.1%） |
| G1～G7业务功能进度 | 93 / 111（83.8%） |
| 当前阶段 | G6 运行时AI与有边界自由 |
| G0阶段进度 | 10 / 10（100%） |
| G1阶段进度 | 13 / 13（100%） |
| G2阶段进度 | 28 / 28（100%） |
...
| TOW-G6-08 | READY | 对话摘要、玩家知识、角色知识和长期最小记忆 | G6-02、G6-04 | World Truth/Player Knowledge/Actor Knowledge隔离；小任务只留必要回执与指纹 |
