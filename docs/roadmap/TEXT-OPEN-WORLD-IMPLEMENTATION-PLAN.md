...
| G7阶段进度 | 11 / 15（73.3%） |
| 当前工作包 | `TOW-G7-13` |
| 当前阻塞项 | `TOW-G7-11`仍等待作者以真实第二模型取得通过回执；`TOW-G7-13`最终完成必须由真人直接玩正式候选版至两个结局，自动化不得代签 |
...
| TOW-G7-13 | BLOCKED | 真人完整游玩与问题分级 | G7-07～G7-12 | 真人直接游玩正式候选版到两个结局；记录体验、叙事、战斗、UI和成本问题。工程侧可继续建设候选版、记录与分级工具，但自动化、模型或开发者脚本不能冒充真人完成证据；同时等待G7-11真实模型回执 |
