...
|---|---|
| 首版工作包 | 121 |
| 已完成 | 116（G0、G1、G2、G3、G4、G5、G6及G7-01～G7-10完成） |
| 产品总进度 | 116 / 121（95.9%） |
| G1～G7业务功能进度 | 106 / 111（95.5%） |
...
| G7阶段进度 | 10 / 15（66.7%） |
| 当前工作包 | `TOW-G7-12` |
| 当前阻塞项 | `TOW-G7-11`工程闸门已完成；发布前仍须由作者使用与生产模型不同的真实Provider/Model显式执行一次付费校准，取得通过回执 |
...
| TOW-G7-12 | READY | 导入导出、删除、版本兼容和迁移测试 | G5-11、G5-12、G7-01 | 完整往返、引用重映射、旧档留存和兼容迁移正反例通过 |
