...
|---|---|
| 首版工作包 | 121 |
| 已完成 | 15（G0全部完成；G1运行包、模块Schema、命令、Action与Condition完成） |
| 产品总进度 | 15 / 121（12.4%） |
| G1～G7业务功能进度 | 5 / 111（4.5%） |
...
| TOW-G1-06 | READY | 扩展Effect DSL与原子 `EffectPlan` | G1-02、G1-05 | 预演、提交、失败回滚、影响域和Receipt完整；禁止任意eval |
