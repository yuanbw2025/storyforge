...
|---|---|
| 首版工作包 | 121 |
| 已完成 | 16（G0全部完成；G1运行包、模块Schema、命令、Action、Condition与Effect完成） |
| 产品总进度 | 16 / 121（13.2%） |
| G1～G7业务功能进度 | 6 / 111（5.4%） |
...
| TOW-G1-07 | READY | 定义Simulation Event分类和顺序规则 | G1-03、G1-06 | 事件可追加、可重放、包含规则版本和随机证据 |
