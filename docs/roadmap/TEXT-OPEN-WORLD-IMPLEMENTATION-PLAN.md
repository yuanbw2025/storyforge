...
|---|---|
| 首版工作包 | 121 |
| 已完成 | 52（G0、G1、G2及G3-01完成） |
| 产品总进度 | 52 / 121（43.0%） |
| G1～G7业务功能进度 | 42 / 111（37.8%） |
| 当前阶段 | G3 AI内容生产编译器 |
| G0阶段进度 | 10 / 10（100%） |
| G1阶段进度 | 13 / 13（100%） |
| G2阶段进度 | 28 / 28（100%） |
