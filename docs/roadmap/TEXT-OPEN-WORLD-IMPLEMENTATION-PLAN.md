...
| TOW-G3-13 | IN_PROGRESS | 技能、物品、敌人、遭遇、奖励目录生产 | G3-05、G3-06、G3-12 | 成长/技能Lane已落地：从已验收Ruleset、PlayerBuild和Manifest生成20级确定性经验/属性曲线，精确兑现两项初始技能、六项等级技能和全部任务技能需求；模型只负责技能/状态语义及有界参数，代码固定稳定键、获得来源、战斗公式覆盖、需求闭合和全部Action/Effect/Condition/Quest绑定unbound。仍需完成敌人/遭遇与物品/奖励Lane后关闭本项 |
