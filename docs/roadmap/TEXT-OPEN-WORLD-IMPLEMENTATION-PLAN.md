...
|---|---|
| 首版工作包 | 121 |
| 已完成 | 20（G0全部完成；G1运行包至Build/Release/InitialState/Session绑定完成） |
| 产品总进度 | 20 / 121（16.5%） |
| G1～G7业务功能进度 | 10 / 111（9.0%） |
...
| TOW-G1-11 | READY | 建立统一成功/失败/降级Receipt | G1-04、G1-06 | UI和AI表现消费同一回执，提交失败前不显示成功 |
