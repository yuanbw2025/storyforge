...
|---|---|
| 首版工作包 | 121 |
| 已完成 | 14（G0全部完成；G1运行包、模块Schema、命令和Action目录完成） |
| 产品总进度 | 14 / 121（11.6%） |
| G1～G7业务功能进度 | 4 / 111（3.6%） |
...
| TOW-G1-05 | READY | 扩展类型化Condition DSL | G1-02 | player/inventory/quest/map/time/relation/actor/world/knowledge条件可静态校验且有深度上限 |
