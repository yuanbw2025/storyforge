...
| **AGENT-1 / HARNESS / CREL** | Phase 27 主 Agent；HARNESS-0～86；CREL-0～14；**本轮阶段性完成** | Master Agent、领域 Skill/闭集工具、Run Contract、durable ledger/checkpoint/lineage/receipt、作用域与信息边界、核心入口迁移、影响 DAG、分级创作产物、1+1 成本停止、确定性归一化、一次定向修复和部分设定叙事脚手架；工程主架构与 CREL 开发已完成并进入实验性社区观察。历史 held-out FAIL 与作者 A/B 0/6 保留，旧 A/B/质量门由产品决策关闭而非通过；社区观察不是遗留开发项 | `R-AGENT1-*`、`R-HARNESS*`、`R-CREL*`、`AI-HARNESS-REBUILD-HANDOFF-20260810.md`、`AI-CREATIVE-RELIABILITY-DEVELOPMENT-20260816.md`、`AI-HARNESS-REBUILD-RELEASE-20260817.md`、`adr/HARNESS-COMMUNITY-VALIDATION.md` |
