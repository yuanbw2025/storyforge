...
> 版本：1.6.13 · 基线：2026-09-14 文字开放世界G6-08长期最小记忆 · 权威层级：L2
...
| E-OPENWORLD-01 | partial | 已在统一Production/Build/ProductRelease和ProductRuntime事件底座上完成G1运行治理、G2确定性玩法闭环、G3 P0～P10/V1～V3/QA内容生产编译器、G4完整玩家端、G5完整Creator生产/发布/更新阶段及G6-01～G6-08运行时AI合同、按需Context、自由输入采用、NPC对白、终态结果演绎、地区任务包装、叙事导演建议和长期最小记忆。成长、任务、地图/快旅、时间天气、NPC日程/生死/关系、战斗、制作、经济、地区演化、受限发牌、动态任务、随机事件与知识历程均可重放；Creator双来源生产、修改、媒资、质量、发布、版本维护、便携恢复和删除已闭合。玩家可显式关闭角色对白窗口，服务回查已完成Dialogue Run与Checkpoint后才写一个私域Memory Event；World Truth不变，Player Knowledge只接受NPC实际说出的允许事实，Actor Knowledge只吸收双方合法已知事实并继续受场景公开门限制。长期状态只保存摘要、闭集键和便携Hash，全文归Harness；旧档空升级及分支继承可重放。六类运行时AI均已接入玩家流程，模型仍无任意状态写权限；结构门不等于已证明文风、防改写式剧透、结果零幻觉、地区文案零重复、导演节奏或摘要相关性质量 | 统一模型失败/超时/预算/余额/断网与成本体验尚未收口；G6-09～G6-10及G7盐脊真人验收、压力/质量校准与旧入口收口仍未完成 |
