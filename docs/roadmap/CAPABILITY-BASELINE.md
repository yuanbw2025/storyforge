...
> 版本：1.6.22 · 基线：2026-09-21 文字开放世界G7-06盐脊最低媒资闭环 · 权威层级：L2
...
| E-OPENWORLD-01 | partial | 已在统一Production/Build/ProductRelease和ProductRuntime事件底座上完成G1运行治理、G2确定性玩法闭环、G3 P0～P10/V1～V3/QA内容生产编译器、G4完整玩家端、G5完整Creator生产/发布/更新阶段及完整G6运行时AI。成长、任务、地图/快旅、时间天气、NPC日程/生死/关系、战斗、制作、经济、地区演化、受限发牌、动态任务、随机事件与知识历程均可重放；Creator双来源生产、修改、媒资、质量、发布、版本维护、便携恢复和删除已闭合。六类运行时AI具有合同、按需Context、自由输入、NPC对白、结果演绎、地区包装、导演建议、长期记忆、统一失败/成本边界及8项版本化评测；每Run最多一次调用，未知结果不隐藏重发，固定玩法始终可用。G7-01至G7-04已完成盐脊独立语义WorldRelease、2区10点程序地图、7段严格主线、两条结局路线、两类重要故事及8固定普通任务/5模板×3变体/16原创事件。G7-05以20级曲线和主线精确1→5级经验预算闭合成长，5项验收技能覆盖攻击/状态/恢复；3敌人家族覆盖3强度、两区和1～5级；至少8装备、4消耗品、5材料、2关键物、4～6配方与两区商店均进入RuntimePackage真实Action/Effect。G7-06进一步闭合1张程序SVG地图、6个关键角色头像和10个逐地点背景；18个图片输出具Blob、来源、许可、权利、alt与完整文字降级，Presentation v3显式绑定媒资主体，玩家从不可变Build/Release显示背景和当前位置头像并在失败时保留文字体验，Location引用和Creator整组重生成链可验。当前136个Scene受159项硬上限保护，完整DAG建议187次调用、产品硬上限200次、token权重202，精确结构化Context不得截断 | 自动化17条路径、压力/真实模型质量、美术质量、真人完整游玩、正式发布更新及旧入口收口仍未完成 |
