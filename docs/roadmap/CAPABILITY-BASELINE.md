...
> 版本：1.6.8 · 基线：2026-09-13 文字开放世界G6-03受治理自由输入 · 权威层级：L2
...
| E-OPENWORLD-01 | partial | 已在统一Production/Build/ProductRelease和ProductRuntime事件底座上完成G1运行治理、G2确定性玩法闭环、G3 P0～P10/V1～V3/QA内容生产编译器、G4完整玩家端、G5完整Creator生产/发布/更新阶段及G6-01～G6-03运行时AI合同、按需Context与自由输入采用。成长、任务、地图/快旅、时间天气、NPC日程/生死/关系、战斗、制作、经济、地区演化、受限发牌、动态任务、随机事件与知识历程均可重放；Creator双来源生产、修改、媒资、质量、发布、版本维护、便携恢复和删除已闭合。六类Skill具备精确V3运行边界与玩家可见资源；其中Intent已真实接入场景UI：冻结例句零模型，其他输入只能生成当前Action/Choice候选，唯一低风险映射、多义选择、高风险确认、严格协议、便携来源证据、stale拒绝和失败降级均已闭合。模型仍不能写正式状态；质量回执不等价于固定文学或美学水平；旧Release继续不可变兼容 | NPC对白、结果演绎、地区包装、导演建议、长期记忆及统一模型故障/成本体验尚未接入；G6-04～G6-10及G7盐脊真人验收、压力/质量校准与旧入口收口仍未完成 |
