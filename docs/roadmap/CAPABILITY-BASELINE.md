...
> 版本：2.2.0 · 基线：2026-09-25 文字开放世界正式入口收口 · 权威层级：L2
...
> 页面状态（2026-09-25）：文字冒险和文字开放世界均已从通用 UI 占位页切换到各自真实 S2/S3 生产与玩家入口，并明确标为“可验证预览”；独立静态 UI 预览不再充当正式产品路由。任何真实入口都不代表本表中的 partial 能力已经完成商业验收。
