...
> 版本：1.6.9 · 基线：2026-09-13 文字开放世界G6-04受治理NPC对白 · 权威层级：L2
...
| E-OPENWORLD-01 | partial | 已在统一Production/Build/ProductRelease和ProductRuntime事件底座上完成G1运行治理、G2确定性玩法闭环、G3 P0～P10/V1～V3/QA内容生产编译器、G4完整玩家端、G5完整Creator生产/发布/更新阶段及G6-01～G6-04运行时AI合同、按需Context、自由输入采用和NPC对白。成长、任务、地图/快旅、时间天气、NPC日程/生死/关系、战斗、制作、经济、地区演化、受限发牌、动态任务、随机事件与知识历程均可重放；Creator双来源生产、修改、媒资、质量、发布、版本维护、便携恢复和删除已闭合。Intent只能映射当前Action/Choice闭集；Dialogue只为当前在场角色读取公开档案、确定性态度及场景允许与角色已知知识交集，严格候选、stale拒绝、精确秘密泄露拦截、只读UI展示和冻结失败模板均已闭合。模型仍不能写正式状态；临时对白不等于长期记忆，结构性边界不等于已证明文风或同义改写防剧透质量；旧Release继续不可变兼容 | 结果演绎、地区包装、导演建议、长期记忆及统一模型故障/成本体验尚未接入；G6-05～G6-10及G7盐脊真人验收、压力/质量校准与旧入口收口仍未完成 |
