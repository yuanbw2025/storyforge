...
| E-TOWN-01 | partial | 已有专属 Brief/SourceSelection/adapter、Production/Build/ProductRelease、六时段语义地图、居民日程、知识隔离、关系、轻经营、离线演化、检查点/分支、专属 Runtime Skill 与玩家界面 | 真实长期内容量、重大变化导演、产品专属媒资与非 fixture 浏览器商业验收仍需继续 |
