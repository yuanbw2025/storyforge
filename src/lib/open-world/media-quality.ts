...
export async function verifyTextOpenWorldMediaRightsV1(input: {
  ...
  if (!isProcedural && origin !== 'generated') fail(`媒资权利来源类型无效:${input.artifact.artifactKey}`)
  ...
  if (!isProcedural && adapterId !== source) {
