...
export const AGENT_SKILLS = [
  ...
  },
  {
    ...
    promptVersion: 'screenplay-source-analysis-v1',
  ...
  },
  {
    ...
    label: '剧本改编因果图',
    owner: 'screenplay-product',
    promptVersion: 'screenplay-causal-graph-v1',
