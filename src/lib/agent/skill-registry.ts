...
export const AGENT_SKILLS = [
  ...
  },
  {
    ...
    regressionTests: ['R-OPEN-WORLD6-runtime-ai-contract', 'R-OPEN-WORLD6-runtime-context-gateway', 'R-OPEN-WORLD6-runtime-ai-eval'],
  },
  {
    version: 1,
    ...
    writeTargets: [],
    lastVerifiedAt: '2026-09-20',
    regressionTests: ['R-OPEN-WORLD6-runtime-ai-contract', 'R-OPEN-WORLD6-runtime-context-gateway', 'R-OPEN-WORLD6-runtime-dialogue', 'R-OPEN-WORLD6-runtime-ai-eval'],
  },
  {
    version: 1,
    ...
    writeTargets: [],
    lastVerifiedAt: '2026-09-20',
    regressionTests: ['R-OPEN-WORLD6-runtime-ai-contract', 'R-OPEN-WORLD6-runtime-context-gateway', 'R-OPEN-WORLD6-runtime-expression', 'R-OPEN-WORLD6-runtime-ai-eval'],
  },
  {
    version: 1,
    ...
    writeTargets: [],
    lastVerifiedAt: '2026-09-20',
    regressionTests: ['R-OPEN-WORLD6-runtime-ai-contract', 'R-OPEN-WORLD6-runtime-context-gateway', 'R-OPEN-WORLD6-runtime-quest-packaging', 'R-OPEN-WORLD6-runtime-ai-eval'],
  },
  {
    version: 1,
    ...
    writeTargets: [],
    lastVerifiedAt: '2026-09-20',
    regressionTests: ['R-OPEN-WORLD6-runtime-ai-contract', 'R-OPEN-WORLD6-runtime-context-gateway', 'R-OPEN-WORLD6-runtime-direction', 'R-OPEN-WORLD6-runtime-ai-eval'],
  },
  {
    version: 1,
    ...
    writeTargets: [],
    lastVerifiedAt: '2026-09-20',
    regressionTests: ['R-OPEN-WORLD6-runtime-ai-contract', 'R-OPEN-WORLD6-runtime-context-gateway', 'R-OPEN-WORLD6-runtime-memory', 'R-OPEN-WORLD6-runtime-ai-eval'],
  },
  {
  ...
  {
    version: 1,
    id: 'text-open-world.production.gameplay-ruleset.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界玩法规则骨架设计',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-gameplay-ruleset-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收GameBrief、ExperienceContract、主角身份或SourceLedger时停止。' },
        partial: { handling: 'require-upstream', instruction: '玩法输入的上游Hash链不完整时停止，不得自行重解释作者边界。' },
        complete: { handling: 'grounded-transform', instruction: '只设计世界化命名与语义；底层规则、Effect权限和G2模块版本全部服从确定性骨架。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.gameplay-ruleset-input']),
    maxOutputTokens: 8_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
    ...
    regressionTests: ['R-OPEN-WORLD3-gameplay-ruleset'],
  },
  {
    version: 1,
    id: 'text-open-world.production.player-build.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界主角身份与初始构筑',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-player-build-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收GameBrief、体验契约、主角资产或GameplayRuleset时停止。' },
        partial: { handling: 'require-upstream', instruction: '主角与玩法Hash链不完整时停止，不得虚构技能、物品目录或运行时定义。' },
        complete: { handling: 'grounded-transform', instruction: '只设计身份演绎、玩法风格及初始技能物品语义；代码冻结属性预算、等级、货币和目录预留键。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.player-build-input']),
    maxOutputTokens: 8_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
    ...
    lastVerifiedAt: '2026-09-07',
    regressionTests: ['R-OPEN-WORLD3-player-build'],
  },
  {
    version: 1,
    id: 'text-open-world.production.story-architecture.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界全局故事弧、结局与叙事承诺',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-story-architecture-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收体验、主角或P1来源证据时停止。' },
        partial: { handling: 'require-upstream', instruction: '来源选择、缺口或上游Hash链不完整时停止，不得把推测写成来源事实。' },
        complete: { handling: 'grounded-transform', instruction: '设计核心目标稳定的长程故事弧、多结局和可检查承诺回收；不得提前创建任务、地区实体或运行条件。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.story-architecture-input']),
  ...
  {
    version: 1,
    id: 'text-open-world.production.region-skeleton.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界地区、地点与连通骨架',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-region-skeleton-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收GameBrief、来源Ledger、体验契约或StoryArc时停止。' },
        partial: { handling: 'require-upstream', instruction: '来源阅读证据、规模或故事空间需求不完整时停止，不得凭空铺地图。' },
        complete: { handling: 'grounded-transform', instruction: '从冻结来源和StoryArc需求设计完整但渐进揭示的空间骨架；代码固定连通、快旅、稳定键与提前到达安全。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.region-skeleton-input']),
    maxOutputTokens: 32_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.mainline.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界严格顺序主线生产',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-mainline-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收StoryArc、结局、地区骨架、玩法规则或主角构筑时停止。' },
        partial: { handling: 'require-upstream', instruction: '主线规模、空间坐标、承诺回收或结局链不完整时停止，不得绕开后续目录造运行键。' },
        complete: { handling: 'grounded-transform', instruction: '编排严格顺序、可等待、可恢复的主线Stage；代码固定等级/时长节奏、Promise落点、多结局、保护与全部未绑定运行槽。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.mainline-input']),
    maxOutputTokens: 32_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.significant-threads.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界重要角色、势力与地区故事线',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-significant-threads-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收来源、故事、地区或主线骨架时停止。' },
        partial: { handling: 'require-upstream', instruction: 'owner覆盖、主线窗口、空间或来源证据不完整时停止，不得臆造运行目录键。' },
        complete: { handling: 'grounded-transform', instruction: '设计角色、势力与地区拥有的重要故事；代码固定安全等待、局部后果、主线兼容、稳定键及全部未绑定运行槽。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.significant-threads-input']),
    maxOutputTokens: 32_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.region-narrative-packs.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界地区叙事生态与内容供给',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-region-narrative-packs-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收来源、地图、主线或重要故事时停止。' },
        partial: { handling: 'require-upstream', instruction: '地区/地点覆盖、内容保底规模或重要故事owner承接不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '为每区设计独特矛盾、生活、角色/势力需求和任务/模板/事件/传闻种子；代码固定覆盖、NPC运行分层、主线保护与未绑定目录槽。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.region-narrative-packs-input']),
    maxOutputTokens: 32_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.quest-skeletons.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界任务骨架与内容需求清单',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-quest-skeletons-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收主线、重要故事、地区生态或玩法规则时停止。' },
        partial: { handling: 'require-upstream', instruction: '故事来源、地区种子或玩法边界不完整时停止，不得提前发明目录引用。' },
        complete: { handling: 'grounded-transform', instruction: '把每个故事Stage和地区种子编译为玩家可执行的任务骨架及语义内容需求；代码固定生命周期、稳定键、目录owner和全部未绑定运行槽。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.quest-skeletons-input']),
    maxOutputTokens: 32_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.progression-catalogs.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界成长与技能目录',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-progression-catalogs-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收玩法骨架、主角构筑或内容需求清单时停止。' },
        partial: { handling: 'require-upstream', instruction: '技能预留键或需求消费者不完整时停止，不得猜测运行绑定。' },
        complete: { handling: 'grounded-transform', instruction: '逐项兑现初始、等级和任务技能需求；模型设计语义与有界参数，代码固定20级曲线、稳定键、覆盖和未绑定运行槽。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.progression-catalogs-input']),
  ...
  {
    version: 1,
    id: 'text-open-world.production.encounter-catalog.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界敌人与遭遇目录',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-encounter-catalog-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收任务、地区、成长或战斗规则时停止。' },
        partial: { handling: 'require-upstream', instruction: '战斗Objective、地点或敌人/遭遇需求不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '逐项设计地区化敌人与遭遇语义；代码固定数值、技能策略、稳定键、地区/战斗目标覆盖和奖励掉落预留。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.encounter-catalog-input']),
  ...
  {
    version: 1,
    id: 'text-open-world.production.item-reward-catalog.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界物品与奖励目录',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-item-reward-catalog-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收任务、成长、遭遇或内容需求时停止。' },
        partial: { handling: 'require-upstream', instruction: '物品来源、任务/遭遇奖励或敌人掉落需求不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '逐项设计物品与奖励语义；代码固定保护、数值、主线经验预算、获得来源、掉落和未绑定运行槽。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.item-reward-catalog-input']),
    maxOutputTokens: 32_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.crafting-economy-catalog.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界配方与经济目录',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-crafting-economy-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收地区、任务、物品或玩法规则时停止。' },
        partial: { handling: 'require-upstream', instruction: '配方/商店需求、候选地点或物品来源不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '逐项设计地区化配方与商店语义并只选择登记候选；代码固定数量、价格、库存、来源/消耗闭环、反套利和未绑定运行槽。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.crafting-economy-input']),
    maxOutputTokens: 32_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.npc-runtime-catalog.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界NPC运行规则目录',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-npc-runtime-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收地区、任务、角色势力需求或商店服务预留时停止。' },
        partial: { handling: 'require-upstream', instruction: '角色/势力消费者、地点、保护层级或服务连续性输入不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '逐项编写人物小传、演绎、势力和日常语义；代码固定Agent/规则分层、保护/死亡、日程、三档关系、服务替代、稳定键及未绑定运行槽。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.npc-runtime-input']),
    maxOutputTokens: 32_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.map-interaction-catalog.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界地图交互目录',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-map-interaction-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收地图、地区地点计划、任务或地点交互需求时停止。' },
        partial: { handling: 'require-upstream', instruction: '地图连通、快旅、任务消费者或提前到达边界不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '逐项把地点需求设计为可点击交互；代码复制拓扑、生成SVG坐标、固定旅行/快旅、全地点覆盖、提前到达安全和未绑定运行槽。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.map-interaction-input']),
    maxOutputTokens: 28_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.quest-finalize.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界任务最终化与地区导演牌组',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-quest-finalize-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收任务骨架、地区叙事包或玩法目录时停止。' },
        partial: { handling: 'require-upstream', instruction: '任务、目标、需求、目录、地区牌组种子或跨Artifact Hash链不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '只补任务与目标可玩语义和有界发牌参数；代码拥有稳定引用、任务生命周期、奖励、Action/Condition/Effect、地区预算及跨目录绑定。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.quest-finalize-input']),
    maxOutputTokens: 32_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.scene-scripts.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界场景脚本与统一交互绑定',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-scene-scripts-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收任务最终稿、地区导演牌组、NPC或地图交互目录时停止。' },
        partial: { handling: 'require-upstream', instruction: '场景需求、知识边界、Action结果权威或模板/事件表现需求不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '只编写场景、对话、选项标签、事件表现和自然语言示例；代码固定全部引用，并让系统Action、固定选项和自然语言候选指向同一P8F Action。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.scene-scripts-input']),
    maxOutputTokens: 32_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.presentation-profile.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界界面表现与文字降级口径',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-presentation-profile-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收GameBrief或ExperienceContract时停止。' },
        partial: { handling: 'require-upstream', instruction: '交互模式、媒资层级或文字降级边界不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '只设计主题语义和逐消费槽文字降级；代码冻结消费槽、三类输入、媒资级别和表现不得拥有玩法结果的边界。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.presentation-profile-input']),
    maxOutputTokens: 8_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
    ...
    lastVerifiedAt: '2026-09-07',
    regressionTests: ['R-OPEN-WORLD3-system-finalize'],
  },
  {
    version: 1,
    id: 'text-open-world.production.system-finalize.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界系统配置、媒资需求与内容预算收口',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-system-finalize-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    inputPolicy: {
      ...
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少已验收P2到P9系统、任务、场景或交互产物时停止。' },
        partial: { handling: 'require-upstream', instruction: '运行模块、UI消费槽、媒资主体、任务时长或跨Artifact Hash链不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '只为代码派生的媒资槽编写创意简报；代码冻结系统配置、UI消费、内容库存/单次时长、预算和文字降级。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.system-finalize-input']),
    maxOutputTokens: 24_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.production.balance-review.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界成长、战斗、奖励与经济平衡评审',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-balance-review-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    optionalContextSourceKeys: [],
    inputPolicy: {
      sourceKeys: ['text-open-world.balance-review-input'],
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少确定性预检或玩法目录时停止。' },
        partial: { handling: 'require-upstream', instruction: '成长、遭遇、奖励、经济、任务可解性或内容供给证据不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '逐指标评审语义体验并定位已给实体；不得推翻确定性事实。低分项只形成新Build局部修复指令，影响闭包由代码计算。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.balance-review-input']),
    maxOutputTokens: 16_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson', 'qualityJson'],
      adoptionExtension: 'product-production-artifacts',
    }],
    lastVerifiedAt: '2026-09-07',
    regressionTests: ['R-OPEN-WORLD3-quality-review'],
  },
  {
    version: 1,
    id: 'text-open-world.production.semantic-review.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界叙事、任务体验与时长语义评审',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-semantic-review-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    ...
    optionalContextSourceKeys: [],
    inputPolicy: {
      sourceKeys: ['text-open-world.semantic-review-input'],
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少确定性预检、来源、故事、任务或场景时停止。' },
        partial: { handling: 'require-upstream', instruction: '来源忠实度、主线、重要故事、地区、任务、对话、重复或时长证据不完整时停止。' },
        complete: { handling: 'grounded-transform', instruction: '逐指标评审叙事体验并定位已给实体；不把审美判断伪装成硬规则。低分项只形成新Build局部修复指令，影响闭包由代码计算。' },
      },
    },
    contextCompression: compressionPolicy(['text-open-world.semantic-review-input']),
    maxOutputTokens: 16_000,
    writeTargets: [{
      table: 'productBuildArtifacts',
      fields: ['payloadJson', 'qualityJson'],
  ...
  {
    version: 1,
    id: 'text-open-world.creator-brief-consult.v1',
    agentId: 'outline',
    defaultForAgent: false,
    label: '文字开放世界创作者 Brief 主会谈',
    owner: 'text-open-world-production',
    promptVersion: 'text-open-world-creator-brief-consult-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    contextSourceKeys: ['manualText'],
    ...
    inputPolicy: {
      sourceKeys: ['manualText'],
      states: {
        empty: { handling: 'require-upstream', instruction: '缺少作者设定与G5-01受控来源摘要时停止。' },
        partial: { handling: 'grounded-transform', instruction: '只澄清当前已给信息；缺口必须列为未决项，不得臆造来源事实。' },
        complete: { handling: 'grounded-transform', instruction: '复述作者目标、识别矛盾并形成可编辑候选；固定产品边界由代码合并。' },
      },
    },
    ...
    regressionTests: ['R-OPEN-WORLD5-creator-brief'],
  },
  {
    version: 1,
