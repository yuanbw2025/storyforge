...
export const TEXT_ADVENTURE_PRODUCTION_AGENT_IDS = [
  ...
  'text-adventure-side-content-designer',
...
export const AGENT_SKILLS = [
  ...
  {
    version: 1,
    id: 'text-adventure.narrative-arc-plan.v1',
    agentId: 'text-adventure-story-architect',
    defaultForAgent: false,
    label: '文字冒险分幕叙事弧与决定回响',
    owner: 'text-adventure-story-architect',
    promptVersion: 'text-adventure-narrative-arc-plan-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
    contextSourceKeys: ['product-production.brief'],
  ...
  },
  {
    ...
    promptVersion: 'text-adventure-scene-script-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-prose',
    readToolNames: [],
    contextSourceKeys: ['product-production.brief'],
  ...
  },
  {
    ...
    agentId: 'text-adventure-side-content-designer',
    defaultForAgent: true,
    label: '文字冒险支线任务生产',
    owner: 'text-adventure-side-content-designer',
  ...
  },
  {
    ...
    promptVersion: 'text-adventure-production-quality-review-v1',
    executionMode: 'product-production',
    contextTaskKind: 'agent-outline',
    readToolNames: [],
...
export function validateAgentSkillDefinitionsV1(
  ...
  const executionModesByAgent: Record<RegisteredAgentId, ReadonlySet<AgentSkillExecutionModeV1>> = {
    ...
    'text-adventure-side-content-designer': productProductionModes,
