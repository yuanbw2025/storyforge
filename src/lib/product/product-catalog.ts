...
export const PRODUCT_CATALOG_V1: readonly ProductCatalogEntryV1[] = Object.freeze([
  ...
  entry({ id: 'independent.motion-drama', label: '漫剧工坊', family: 'independent-creation', status: 'released', charterPhase: 'C', requiresWorldReference: false, ownsRuntime: false, ownsMedia: true, maturityNote: '一句话或小说来源冻结、系列与物料圣经、逐集剧本、分镜、双 Prompt IR、Seedance/Runway/LTX 适配包、质量门与不可变发布已形成闭环；不包含视频生成和成片制作。' }),
