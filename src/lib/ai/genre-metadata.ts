...
export const GENRE_METADATA: GenreMetadata[] = [
  ...
  // ── 冷战式氛围（架空异世界适用） ──
  {
    ...
    label: '冷战式氛围',
    emoji: '🕵️',
    description: '阵营对峙、谍战暗涌、科技竞赛——冷战式的结构性张力，适用于架空/异世界',
    antiPatterns: [
      '避免现代数字技术（无互联网、无智能手机、无 GPS）——技术上限约等于我们的 1940s-1980s',
      '避免敌我阵营脸谱化——每个阵营内部都有理想主义者、犬儒主义者和投机分子',
      '避免情报工作过于光鲜——大部分时间是等待、监听、分析、写报告',
      '避免忽视"体制"的存在——无论哪个世界，官僚体系本身就是一种力量',
      '避免"终极武器"只是背景板——它应该始终影响角色的选择和世界的走向',
      '允许魔法/超凡元素存在，但应有限制、有代价、可被理解——像核技术一样，它不是万能的',
    ],
    pacingStrategy: '慢热积蓄→情报突破→行动爆发 三段循环。等待和障碍不是水字数——监听录音里的杂音、破译密电的挫败、分析情报的不确定性，这些本身就是紧张感的来源。每次行动高潮后回归到更深的疑惑而非满足。',
    typicalStructure: [
      { title: '对峙', description: '世界被分割为几大阵营，主角在裂缝中第一次意识到表面的和平有多脆弱' },
      { title: '暗涌', description: '情报网、秘密交易、技术竞赛、代理人冲突——在"和平"的表象下，战争以另一种方式进行' },
      { title: '临界', description: '终极武器被激活的边缘——一场危机将所有阵营拖到毁灭的边缘' },
      { title: '重组', description: '旧秩序瓦解或重组——但和平的新世界并不比旧世界简单，或者，世界根本就没有走向和平' },
    ],
  },
]
