...
import { exportCommunityPrototypeDistributionBundleV2 } from '../../lib/product-platform/distribution-bundle'
...
export default function ProductProductionStudio(props: {
  ...
  const [visualLevel, setVisualLevel] = useState<'none' | 'key-scenes'>(initialProduct === 'avg' || initialProduct === 'ai-town' ? 'key-scenes' : 'none')
