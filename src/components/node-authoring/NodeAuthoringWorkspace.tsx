...
export default function NodeAuthoringWorkspace(props: { project: Project; worldGroupId: number | null }) {
  ...
  return <div data-testid="node-authoring-workspace" className="flex h-[760px] min-h-[560px] max-h-[calc(100vh-180px)] flex-col overflow-hidden bg-bg-base">
