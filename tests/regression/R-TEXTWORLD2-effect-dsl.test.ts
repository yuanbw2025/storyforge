...
function state(overrides: Partial<TextOpenWorldEffectStateV1> = {}): TextOpenWorldEffectStateV1 {
  const initial: TextOpenWorldEffectStateV1 = {
    ...
    map: {
      ...
      unlockedFastTravelPointKeys: ['fast-travel.salt-port'], travel: null,
    },
    time: { worldMinute: 480 },
    ...
    world: { regionStateByKey: {}, flags: {} },
    knowledge: { visibilityByKey: { 'knowledge.caretaker': 'known' } },
